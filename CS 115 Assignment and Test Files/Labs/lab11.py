...
def read_file(filename):
    '''Group Effort: Returns all strings from the text file specified'''
...
def readLines_file(filename):
    '''Group Effort: Returns a list containing each line from the file specified as a list item.'''
    myfile = open(filename, "r")
