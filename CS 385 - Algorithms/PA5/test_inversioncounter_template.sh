...
# Version : 1.0
# Date    : 10/31/23
# Description : Test file for the inversioncounter.cpp file
...
run_test_with_args_and_input "slow" "3" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 0"
run_test_with_args_and_input "slow" "3 5 5" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 0"
run_test_with_args_and_input "slow" "2 1 4 3 0" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 6"
run_test_with_args_and_input "slow" "4 7 2 3 1" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 8"
run_test_with_args_and_input "slow" "1 2 3 4 0" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 4"
...
run_test_with_args_and_input "slow" "7 1 8 2 9" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 3"
run_test_with_args_and_input "slow" "4 1 4 3 6 5" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 4"
run_test_with_args_and_input "slow" "7 3 1 6 2 6 6" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 9"
run_test_with_args_and_input "slow" "5 2 3 3 0 2 1" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 15"
run_test_with_args_and_input "slow" "1 1 1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 0"
run_test_with_args_and_input "slow" "$(seq 100000 1)" "Enter sequence of integers, each followed by a space: Number of inversions (slow): 4999950000"
...
run_test_with_args_and_input "" "3 5 5" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 0"
run_test_with_args_and_input "" "2 1 4 3 0" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 6"
run_test_with_args_and_input "" "4 7 2 3 1" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 8"
run_test_with_args_and_input "" "1 2 3 4 0" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 4"
run_test_with_args_and_input "" "5 4 3 2 1" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 10"
run_test_with_args_and_input "" "7 1 8 2 9" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 3"
run_test_with_args_and_input "" "4 1 4 3 6 5" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 4"
run_test_with_args_and_input "" "7 3 1 6 2 6 6" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 9"
run_test_with_args_and_input "" "5 2 3 3 0 2 1" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 15"
run_test_with_args_and_input "" "1 1 1 1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 0"
run_test_with_args_and_input "" "$(seq 100000 1)" "Enter sequence of integers, each followed by a space: Number of inversions (fast): 4999950000"
